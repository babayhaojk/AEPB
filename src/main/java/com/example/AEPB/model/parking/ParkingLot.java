...
public class ParkingLot {
    ...
    public Optional<String> park(Car car){
        if (parkingLocation.containsKey(car.getCarNumberNo())){
            throw new RuntimeException("CarNumberNo is exist");
        }
        ...
        parkingLocation.put(car.getCarNumberNo(), location);
        cars.add(location, car);
        return Optional.of(car.getCarNumberNo());
    }
